...
(function () {
    ...
    class Sprite_CutInBase extends Sprite {
        ...
        getMainRotation() {
            if (!this._mainRotationCache) {
                const rotation = valueCutInSet1[2];//変更
    ...
    class Sprite_CutInWoss extends Sprite_CutInBase {
        getMainSmallHeight() {
            if (!this._mainSmallHeightCache) {
                this._mainSmallHeightCache = this.getMainWidth() / valueCutInSet1[3];//変更4
            }
        ...
        getMainLargeHeight() {
            if (!this._mainLargeHeightCache) {
                this._mainLargeHeightCache = this.getMainWidth() / valueCutInSet1[4];//変更2
            }
            return this._mainLargeHeightCache;
        }

        getOpenAndCloseTime() {
            return valueCutInSet1[5];//変更25
        }

        getStopTime() {
            return valueCutInSet1[6];//変更10
        }
        ...
        _createCharacterInnerSprite() {
              const characterBitmap = ImageManager.loadPicture(valueCutInSet1[1]);//変更
    ...
    function commandShowActorCutIn({ name }) {
        ...
        if(!$gameSwitches.value(428)){//変更。ウェイトなし
