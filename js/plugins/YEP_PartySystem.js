...
Window_PartyDetail.prototype.refresh = function() {
    ...
    this.drawActorBasicInfo2();//変更。プロフィール行追加
};
...
Window_PartyDetail.prototype.drawActorBasicInfo2 = function() {//変更追加。プロフィール行追加
    var y = 400;
    var padding = 0;
    var xpad = padding;
    this.changeTextColor(this.systemColor());
    this.drawProfile(xpad,y);
};

Window_PartyDetail.prototype.drawProfile = function(x, y) {//変更追加。プロフィール行追加
    this.drawTextEx(`\\fs[25]${this._actor.profile()}`, x, y);
};
...
Scene_Party.prototype.createCommandWindow = function() {
    ...
    //this._helpWindow.height = 160;//変更
