...
Game_Player.prototype.moveByInput = function() {
	...
	if (this._pickup.enabled && this.canMove()) {
	    if (Input.isPressed('ok')) {this.throwTarget();return};  //変更Input.isPressed('cancel')Input.isRepeated('ok')
		if (Input.isPressed(this._dirButtonK)) {this.holdDirectionT();return};  //変更Input.isPressed(this._dirButtonK)
    };
