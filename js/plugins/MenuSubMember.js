...
/*:
 * @plugindesc display sub member at menu window and field (Ver1.2.1)
...
/*:ja
 * @plugindesc メニュー画面と隊列の最後尾に同行者を表示します(ver1.2.1)
...
(function() {
  ...
  Window_SubMember.prototype.refresh = function() {
    ...
    if(numLines < 5 || this.y != 324){
      ...
      this.x = 180;
      this.y = 460;//Graphics.height - 72 - this.height - 50;
    };
    // set visible status
