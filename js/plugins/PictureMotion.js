 ...
 * 制御点座標値を 600, 0, 550, 660 にするには660が600?
 * bezier 0 550 を指定します。
 * -----------------------------------
 * 「wave p1 p2」振動
 * 
	...
	Game_Interpreter.prototype.pluginCommand = function(command, args){
		...
		switch(command){
			...
			case "Motion_Initialize":
				...
				curveFunctions.patternX = curveFunctions.getPattern("smooth2", [0]);
				curveFunctions.patternY = curveFunctions.getPattern("smooth2", [0]);
				curveFunctions.patternScaleX = curveFunctions.getPattern("smooth2", [0]);
				curveFunctions.patternScaleY = curveFunctions.getPattern("smooth2", [0]);
				curveFunctions.patternOpacity = curveFunctions.getPattern("smooth2", [0]);
				break;
