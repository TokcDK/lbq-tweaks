...
Window_Base.prototype.updateBackgroundOpacity = function() {
    this.opacity = valueMenuBackOpacity;//Moghunter.mback_opacity;//変更。
};
...
Scene_MenuBase.prototype.refreshBackgroundName = function() {
	...
	this._backImg = ImageManager.loadParallax(this.set_background_img());
};
...
Scene_MenuBase.prototype.update_mbackground = function() {
	...
	this._backgroundSpriteNew.origin.x += $gameVariables.value(81);
	this._backgroundSpriteNew.origin.y += $gameVariables.value(82);
