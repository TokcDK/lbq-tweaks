...
Sprite_ImprovedBattleback.prototype.setup = function(bf, sp1) {
  ...
  var margin = Yanfly.Param.IBBMargin;
    var x = -200;//-this._battleField.x - margin-360://;
    var y = -238;//-this._battleField.y - margin-216;//;
    var w = 1680;//Graphics.width + margin * 2;//;
    var h = 1243;//Graphics.height + margin * 2+200;//;	
  this.move(x, y, w, h);//変更。x,0,w,hの0をy
...
Sprite_ImprovedBattleback.prototype.setupLocationY = function() {
  ...
  this.origin.y = sprite1.y + (this.bitmap.height - height)/2;//変更。xの処理に倣う
};
