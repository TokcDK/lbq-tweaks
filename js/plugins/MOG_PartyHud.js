...
ImageManager.loadPartyHud = function(filename) {
    return this.loadBitmap('img/actorhud/', filename, 0, true);//変更
};	
...
PartyHud.prototype.createLayout = function() {
     this._layout = new Sprite(ImageManager.loadPartyHud("PartyLayout"));//変更。以下CGはParty付記
...
PartyHud.prototype.createFace = function() {
	 ...
	 this._face.y = this._layout.y + Number(Moghunter.partyHud_FaceY);
       this._face.scale.x = 0.5; //変更。scale追加
       this._face.scale.y = 0.5;
	 this.refreshFace();
...
PartyHud.prototype.createHPMeter = function() {
     this._hpmeter = new Sprite(ImageManager.loadPartyHud("PartyHPMeter"));
...
PartyHud.prototype.createMPMeter = function() {
     this._mpmeter = new Sprite(ImageManager.loadPartyHud("PartyMPMeter"));
...
PartyHud.prototype.createTPMeter = function() {
     this._tpmeter = new Sprite(ImageManager.loadPartyHud("PartyTPMeter"));
...
PartyHud.prototype.createExpMeter = function() {
     this._expmeter = new Sprite(ImageManager.loadPartyHud("PartyEXPmeter"));
