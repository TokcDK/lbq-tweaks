...
(() => {
    ...
    Window_Base.prototype.mppConvertItemName = function(type, icon, itemId) {//変更。アイテム類にデフォカラー
        let text = '';
        let item;
        let itemColor;
        switch (type.toUpperCase()) {
            case 'S':
                ...
                if(item.stypeId == 9){
                  ...
                  if(item.stypeId == 10){
                    ...
                    if(item.stypeId == 14 || item.stypeId == 15){
                      itemColor = 27;
                    } else {
                      itemColor = 2;
                    };
            ...
            case 'W':
                ...
                if([201,202,203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220].some(function(id){return itemId == id})){
                  itemColor = 23;
                } else {
                  itemColor = 14;
                };
            ...
            case 'A':
                item = $dataArmors[itemId];
                  if(item.atypeId == 5 || item.atypeId == 8){
                    itemColor = 31;
                  } else {
                    itemColor = 20;
                  };
        ...
        if (item) {
            ...
            if(itemColor != 0){
              text += `\x1bC[${itemColor}]${item.name}\x1bC[0]`;
            } else {
              text += item.name;
            };
        }
