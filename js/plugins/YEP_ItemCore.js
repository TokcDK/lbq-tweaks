...
Window_ItemCategory.prototype.windowWidth = function() {
    if (SceneManager._scene instanceof Scene_Item) return 240 + 300; //変更+300
...
Window_ItemCategory.prototype.maxCols = function() {
    if (SceneManager._scene instanceof Scene_Item) return 3;  //変更1から3
...
Window_ItemList.prototype.initialize = function(x, y, width, height) {
    if (SceneManager._scene instanceof Scene_Item) {
      width = Graphics.boxWidth / 2 + 200;  //変更+200
    }
...
Window_ItemList.prototype.maxCols = function() {
    if (SceneManager._scene instanceof Scene_Item) return 2;  //変更1から2
...
Window_ItemActionCommand.prototype.windowWidth = function() {
    return Graphics.boxWidth / 2 + 200;  //変更+200を追加
};
