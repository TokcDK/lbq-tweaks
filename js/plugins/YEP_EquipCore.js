...
Scene_Equip.prototype.createSlotWindow = function() {
    ...
    var ww = Graphics.boxWidth / 2 + 150; //変更+150を追加
...
//変更Yanfly.Equip.Scene_Equip_commandOptimize =
...
Scene_Equip.prototype.updateLowerRightWindowTriggers = function() {
    ...
    if (Input.isRepeated('shift')) { //変更rightをmenu
      this.shiftLowerRightWindows();
    } else if (Input.isRepeated('tab')) { //leftをtab
